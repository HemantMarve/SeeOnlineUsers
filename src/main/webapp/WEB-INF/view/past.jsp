...
<%int i=0; %>
<c:forEach var="u" items="${sessionScope.past}">
  ...
  </svg><span class="tooltiptext">Name:<c:out value="${u.user}"/><br>Age:<c:out value="${u.age}"/><br>LastTime:<c:out value="${u.time}"/></span></div>
  <%i++;%>
 </c:forEach>  <br>
 <h2 style="color:green;">Past Visiters:<%=i %>(Referesh To see new Offline users)</h2> <br>    
 <a href="invalidate.htm" class="button">Logout</a><br><br>                                                                    
       <a href="present.htm" class="button">SeePresentVisiters</a>
